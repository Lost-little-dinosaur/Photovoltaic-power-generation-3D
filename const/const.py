...
column = {  # 0表示完整 1表示扣除 1上竖排 2横排 3下竖排
    ("182-78膨胀常规", 0, 1, 0, 0, 0): [int(1250 / UNIT)],
    ("182-78膨胀常规", 1, 0, 0, 0, 0): [int(1100 / UNIT)],
    ("182-78膨胀常规", 2, 0, 0, 0, 0): [int(1900 / UNIT), int(1750 / UNIT)],
    ("182-78膨胀常规", 3, 0, 0, 0, 0): [int(1900 / UNIT), int(3200 / UNIT)],
    ("182-78膨胀常规", 4, 0, 0, 0, 0): [int(1700 / UNIT), int(2600 / UNIT), int(3200 / UNIT)],
    ("182-78膨胀常规", 5, 0, 0, 0, 0): [int(1700 / UNIT), int(2600 / UNIT), int(2600 / UNIT), int(3750 / UNIT)],
    ("182-78膨胀常规", 1, 1, 0, 0, 0): [int(2600 / UNIT)],
    ("182-78膨胀常规", 2, 1, 0, 0, 0): [int(1350 / UNIT), int(2950 / UNIT)],
    ("182-78膨胀常规", 3, 1, 0, 0, 0): [int(1700 / UNIT), int(2600 / UNIT), int(2450 / UNIT)],
    ("182-78膨胀常规", 4, 1, 0, 0, 0): [int(1700 / UNIT), int(2600 / UNIT), int(2600 / UNIT), int(2500 / UNIT)],

}  # 182-78常规
limit_column = {
    ("182-78膨胀常规", 0, 1, 0, 0, 0): [int(250 / UNIT), columNlimit / UNIT],
    ("182-78膨胀常规", 1, 0, 0, 0, 0): [int(250 / UNIT), columNlimit / UNIT],
    ("182-78膨胀常规", 2, 0, 0, 0, 0): [int(250 / UNIT), columNlimit / UNIT],
    ("182-78膨胀常规", 3, 0, 0, 0, 0): [int(800 / UNIT), columNlimit / UNIT],
    ("182-78膨胀常规", 4, 0, 0, 0, 0): [int(250 / UNIT), columNlimit / UNIT],
    ("182-78膨胀常规", 5, 0, 0, 0, 0): [int(250 / UNIT), columNlimit / UNIT],
    ("182-78膨胀常规", 1, 1, 0, 0, 0): [int(250 / UNIT), columNlimit / UNIT],
    ("182-78膨胀常规", 2, 1, 0, 0, 0): [int(500 / UNIT), columNlimit / UNIT],
    ("182-78膨胀常规", 3, 1, 0, 0, 0): [int(250 / UNIT), columNlimit / UNIT],
    ("182-78膨胀常规", 4, 1, 0, 0, 0): [int(250 / UNIT), columNlimit / UNIT],
}  # 182-78常规_左右限制
